<!--
Thanks for contributing to gocldr. Please keep the PR focused on a single
...
- [ ] Behavior still matches ECMA-402 `Intl.*` where relevant
- [ ] Generated files (`*/tables_gen.go`, `*/locales/`, `*/testdata/`) were regenerated with `make gen`, not hand-edited
